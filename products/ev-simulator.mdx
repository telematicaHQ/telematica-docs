...
2. __Auto-updating simulated vehicle (charging only):__ 
 An EV that is always being charged where you can also customize factors affecting the charging speed (EV battery size, State of Charge, Max. charging rate of EV, Max. charging rate of charger, Environmental factor).

3. __Auto-updating simulated vehicle (driving only):__ 
 An EV that is always driving where you can customize the trip parameters like the length of the trip, speed, climate control and occupancy.
